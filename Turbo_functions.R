...
#' @param signatureNum the number of mutation signatures
#' @param sampleNum the number of cancer genomes
convertToTurboQ <- function(vQ, signatureNum, sampleNum) {
...
convertToTurboF <- function(vF, fdim, signatureNum, isBackground) {
...
#' @param signatureNum the number of mutation signatures
#' @param sampleNum the number of cancer genomes
convertFromTurboQ <- function(turboQ, signatureNum, sampleNum) {
...
#' @param signatureNum the number of mutation signatures
#' @param isBackground the logical value showing whether a background mutaiton features is included or not
convertFromTurboF <- function(turboF, fdim, signatureNum, isBackground) {
